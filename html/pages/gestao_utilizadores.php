            ...
            <?php while ($aluno = $alunos->fetch_assoc()) { ?>
                <div class="user-card">
                    ...
                    <div class="user-actions">
                        <a href='admin_dashboard.php?page=editar_aluno&id=<?= $aluno['id_aluno'] ?>' class="edit"><i class="fas fa-pen-to-square action-icon"></i> Editar</a>
                        <a href='pages/excluir_aluno.php?id=<?= $aluno['id_aluno'] ?>' class="delete"><i class="fas fa-trash action-icon"></i> Excluir</a>
                    </div>
                </div>
            <?php } ?>
        </div>
        ...
        <div class="users-grid">
            <?php while ($empresa = $empresas->fetch_assoc()) { ?>
                <div class="user-card">
                    ...
                    <div class="user-actions">
                        <a href='admin_dashboard.php?page=editar_empresa&id=<?= $empresa['id_empresas'] ?>' class="edit"><i class="fas fa-pen-to-square action-icon"></i> Editar</a>
                        <a href='pages/excluir_empresa.php?id=<?= $empresa['id_empresas'] ?>' class="delete"><i class="fas fa-trash action-icon"></i> Excluir</a>
                    </div>
                </div>
            <?php } ?>
        </div>
    ...
    <div id="professores" class="section">
        ...
        <div class="users-grid">
            <?php while ($professor = $professores->fetch_assoc()) { ?>
                <div class="user-card">
                    <div class="profile-pic-container">
                        <img src="<?= !empty($professor['foto']) ? '../images/' . $professor['foto'] : '../images/professor_default.png' ?>" alt="Foto do Professor">
                    </div>
                    ...
                    <div class="user-actions">
                        <a href='admin_dashboard.php?page=editar_professor&id=<?= $professor['id_professor'] ?>' class="edit"><i class="fas fa-pen-to-square action-icon"></i> Editar</a>
                        <a href='pages/excluir_professor.php?id=<?= $professor['id_professor'] ?>' class="delete"><i class="fas fa-trash action-icon"></i> Excluir</a>
                    </div>
                </div>
            <?php } ?>
        </div>
