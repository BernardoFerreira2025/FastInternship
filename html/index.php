        ...
        <div class="container">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    ...
                    <h3>Professores</h3>
                    <p>Validam as candidaturas e ajudam a garantir que cada aluno seja encaminhado para a empresa certa.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon"><i class="fas fa-building"></i></div>
                    <h3>Empresas</h3>
                    <p>Publicam ofertas de estágio e analisam os perfis dos alunos sugeridos.</p>
                </div>
            </div>
        </div>
    </section>
