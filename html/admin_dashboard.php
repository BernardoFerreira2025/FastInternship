    ...
    <div class="admin-dashboard">
        ...
        <nav class="admin-sidebar">
            ...
            <div class="menu-items">
                ...
                <a href="admin_dashboard.php?page=gerir_ofertas" class="menu-item <?php echo $page === 'gerir_ofertas' ? 'active' : ''; ?>">
                    <i class="fas fa-briefcase"></i> Publicar Ofertas
                </a>
                <a href="admin_dashboard.php?page=gestao_utilizadores" class="menu-item <?php echo $page === 'gestao_utilizadores' ? 'active' : ''; ?>">
